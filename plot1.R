...
with(data,hist(as.numeric(as.character(Global_active_power)),col = "red",xlab = "Global Active Power (Kilowatts)",main = "Global Active power")) #creating a histogram for Global_active_power 
setwd("./ExData_Plotting1")
dev.copy(png, file= "plot1.png", width= 480, height= 480) #copied the plot to a png device
dev.off()
